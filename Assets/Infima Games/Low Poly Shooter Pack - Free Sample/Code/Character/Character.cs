...
namespace InfimaGames.LowPolyShooterPack
{
	...
	public sealed class Character : CharacterBehaviour
	{
		...
		/// <summary>
		/// Look Axis Values for jump.
		/// </summary>
		private bool jumpMovement; //yq

		/// <summary>
		/// Current Health for player.
		/// </summary>
		private int currentHealth = 100; // yq
		...
		public override bool GetJumpMovement() => jumpMovement; //yq

		public override int getCurrentHealth() => currentHealth; //yq
		...
		#region Zombie Attack
		// public void OnCollisionEnter(Collision collision)
		// {
		// 	if (collision.gameObject.tag == "Zombie") // TODO: add zombie name
		// 	{
		// 		Debug.Log("Collide");
		// 		// currentHealth -= 10;
		// 		// if (currentHealth <= 0)

...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Movement : MovementBehaviour
    {
        ...
        [SerializeField]
        private float speedJumping = 5.0f;
        ...
        private void MoveCharacter()
        {
            ...
            // Only calculate jumping speed when grounded
            if (grounded)
            {
                ySpeed = 0.0f; //let ySpeed = 0 when grounded
                // Only can jump when grounded
                if (playerCharacter.GetJumpMovement())
                {
                    ySpeed = speedJumping;
                }
            }
            else // only calculate speed when dropping/in air
